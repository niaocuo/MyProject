    ...
    <el-form :inline="true"  :model="formData" class="demo-form-inline" >
      <el-row style="margin-top: 1rem">
        ...
        <el-col :span="7" :offset="10" style="text-align: right">
          <el-form-item >
            <el-input  placeholder="请输入标题" v-model="formData.title"><i slot="prefix" class="el-input__icon el-icon-search"></i></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  export default {
    ...
    methods: {
      getTableData(){
        this.$http.post(api+'/manager/getInformationPage',
          {
      ...
      addInformation(){
        this.$router.push({path:'/manager/editorInformation'});
      },
      ...
      editorClick(id){
        this.$router.push({path:'/manager/editorInformation', query:{id:id}});
      },
      deleteClick(id){
        ...
        this.$http.post(api+'/manager/deleteInformation', id).then(function(response){
          if(response.data.code='200'){
            this.reload();
